...
Cursos.addEventListener('click', e => {
    if (e.target.classList.contains('card_Btn')) {
        if (e.target.classList.contains('card_Btn')) {
            Swal.fire({
                title: 'Inicia sesión en nuestra app para acceder a los cursos.',
                html: '<iframe src="https://embed.lottiefiles.com/animation/96546"></iframe>',
